         ...
         <div className="container col-md-4 col-sm-12">
          ...
          {toast && <p className='text-success'>{toast}</p>}
           ...
           <label htmlFor="name" className='form-label'>Name</label>
            <input type="text"  className='form-control' id='name' placeholder='Enter your name' name='name' value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
          {formik.touched.name && formik.errors.name ?   <div className="text-danger fst-italic">{formik.errors.name}</div> : null}
           ...
           <label htmlFor="retypePassword" className='form-label'>Retype Password</label>
            <input type="password"  className='form-control' id='retypePassword' placeholder='Enter your confirm password' name='confirmPassword' value={formik.values.confirmPassword} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
